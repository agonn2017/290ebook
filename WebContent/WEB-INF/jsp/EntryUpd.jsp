...
<body onload="show1();">
<form action="${pageContext.request.contextPath}/ec/EntryUpd.html" method="post"  
			onsubmit="return check()">

	<div class="container">
	<input type="text" id="id" name="id"  value="${objEntry.id}">
		<div class="row">
		...
		<div class="row">
			...
			<div class="col-sm-2">
				<input type="text" id="title" name="title" value="${objEntry.title}">
			</div>
		</div>
		&nbsp;
		<div class="row">
			...
			<div class="col-sm-5">
				<textarea  id="summary" name="summary" cols="50" rows="5">${objEntry.summary}</textarea>
			</div>
		</div>
		&nbsp;
		<div class="row">
			...
			<div class="col-sm-2">
				<input type="text" id="uploaduser" name="uploaduser" value="${objEntry.uploaduser}">
			</div>
		</div>
		&nbsp;
		<div class="row">
			...
			<div class="col-sm-2">
				<input type="date" id="createdate" name="createdate" value="${objEntry.createdate}">
			</div>
		</div>
		&nbsp;
